...
BUILD_FLAGS ?= -ldflags '-s -w -X "github.com/L-Chao/graphjin/serv.version=${BUILD_VERSION}" -X "github.com/L-Chao/graphjin/serv.commit=${BUILD}" -X "github.com/L-Chao/graphjin/serv.date=${BUILD_DATE}"'
